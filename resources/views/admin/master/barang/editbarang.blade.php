                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                @if ($barang->image) 
                                <img src="{{ asset('storage/' . $barang->image) }}" class="img-preview img-fluid mb-3 col-sm-3 d-block">
                                @else
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="deskripsi" value="{{ old('deskripsi', $barang->deskripsi) }}" class="form-control @error('deskripsi') is-invalid @enderror" required autocomplete="off" placeholder="Masukan Deskripsi Barang. . . ">
                                @error('deskripsi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
